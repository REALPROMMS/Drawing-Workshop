...
/* Поиск по списку. 
	div	
		input	id="ID" onkeyup="search_in_list(ID)"
		ul
			li
			li	
		/ul
...
let closeupBtn = document.querySelectorAll('.closeup .btn');
if (closeupBtn.length > 0) {
  closeupBtn.forEach(btn => {

    btn.addEventListener('click', () => {
      const block = btn.closest('.closeup')
